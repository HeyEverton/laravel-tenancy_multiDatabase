<div>
    ...
    <div class="py-12" x-data="{ open: false }">
            ...
            @forelse($menuItems as $item)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-5">
                    <div class="p-6 flex justify-between bg-white border-b border-gray-200">
                        ...
                        <div class="flex">
                            <div
                                class="w-28 h-28 flex items-center justify-center mr-8
                        ...
                        <div class="flex items-center gap-2">
                            <button
                                @click="Livewire.emit('editMenuItem', {{ $item->id }}); open = true;"
                            ...
                            <livewire:tenants.restaurants-menu.delete menu="{{ $item->id }}"
                                key="{{ $item->id }}" />
                        </div>
        ...
        @include('livewire.tenants.restaurants-menu.modal.item-modal')
    </div>

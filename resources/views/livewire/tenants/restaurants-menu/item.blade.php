<div class="mt-10">
    ...
    <form>
        <div class="w-full mb-8">
            ...
            <input type="text" class="w-full rounded mt-2 @error('menu.item') border-red-700 @enderror"
                wire:model="menu.item">
        ...
        <div class="w-full mb-8">
            ...
            <input type="text" class="w-full rounded mt-2 @error('menu.description') border-red-700 @enderror"
                wire:model="menu.description">
